            ...
            <table class="table table-hover table-striped" id="tableData">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <button class="btn btn-primary btn-edit" data-id="{{$prainterview->jadwal_id}}" data-select="{{$prainterview->jadwal->lamaran_id}}"><i class="{{Auth::guard('weboperator')->user()->role == 'Petugas' ? 'ri-pencil-fill' : 'fa fa-eye'}}"></i></button>
