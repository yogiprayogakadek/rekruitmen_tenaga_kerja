...
$(document).ready(function () {
    ...
    $('body').on('change', '.lamaran', function() {
        $('.rekomendasi').empty();
        let lamaran = $(this).val();
        if(lamaran == '') {
            $('.will-show').hide()
        } else {
            $('.will-show').show();
    ...
    $('body').on('click', '.btn-print', function () {
        Swal.fire({
            title: 'Cetak data pra interview?',
